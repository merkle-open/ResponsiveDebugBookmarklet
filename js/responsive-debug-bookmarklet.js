...
*/
var baseurl = 'http://l0k.de/nrd/dev'; /* DEV-URL needs to be changed for page! */
    ...
    function initNamicsResponsiveDebugBookmarklet() {
        (window.namicsResponsiveDebugBookmarklet = function() {
            ...
            function init() {
                ...
                /*remoteStorage.setValue("testKey", "Toll!!");
                remoteStorage.getValue("testKey", function(key, value){
